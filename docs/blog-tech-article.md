...
所以我花了大概两周时间，写了一个混合架构的 brief 生成器：**Brief Builder**。规则引擎负责"对不对"，LLM 负责"好不好"。
...
Brief Builder 已开源，MIT 协议，欢迎 star 和 PR：

**GitHub**: [https://github.com/seafhven-ss/brief-builder](https://github.com/seafhven-ss/brief-builder)
